...
CREATE TABLE `configuracoes_whitelabel` (
  ...
  `website_url` varchar(500) DEFAULT NULL COMMENT 'URL do site da empresa para teste de captura',
...
--
-- Estrutura para tabela `document_validations`
--

CREATE TABLE `document_validations` (
  `id` int(11) NOT NULL,
  `cliente_id` int(11) DEFAULT NULL COMMENT 'ID do cliente (kyc_clientes)',
  `kyc_empresa_id` int(11) DEFAULT NULL COMMENT 'ID da empresa KYC associada',
  `user_id` int(11) DEFAULT NULL COMMENT 'Quem fez o upload (admin ou cliente)',
  `document_type` varchar(50) DEFAULT NULL COMMENT 'RG, CNH, CPF, COMPROVANTE_RESIDENCIA, OUTROS',
  `file_path` varchar(255) DEFAULT NULL COMMENT 'Caminho do arquivo no servidor',
  `file_name` varchar(255) DEFAULT NULL COMMENT 'Nome original do arquivo',
  `file_size` int(11) DEFAULT NULL COMMENT 'Tamanho do arquivo em bytes',
  `mime_type` varchar(100) DEFAULT NULL COMMENT 'Tipo MIME (image/jpeg, application/pdf, etc)',
  `confidence_score` int(11) DEFAULT NULL COMMENT 'Score de confiança do OCR (0-100)',
  `extracted_data` text DEFAULT NULL COMMENT 'JSON com dados extraídos (CPF, RG, CNPJ, nome, etc)',
  `text_content` text DEFAULT NULL COMMENT 'Texto completo extraído pelo OCR',
  `validation_status` enum('pending','approved','rejected','review_needed') DEFAULT 'pending',
  `validation_notes` text DEFAULT NULL COMMENT 'Observações do analista',
  `validated_by_user_id` int(11) DEFAULT NULL COMMENT 'Quem aprovou/rejeitou',
  `validated_at` datetime DEFAULT NULL,
  `created_at` datetime DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Armazena logs de validação OCR de documentos do KYC';

-- --------------------------------------------------------

--
-- Estrutura para tabela `document_verifications`
--
...
CREATE TABLE `document_verifications` (
  ...
  `validation_score` int(11) DEFAULT 0,
  `validation_max_score` int(11) DEFAULT 0,
...
--
-- Estrutura para tabela `facial_verifications`
--

CREATE TABLE `facial_verifications` (
  `id` int(11) NOT NULL,
  `cliente_id` int(11) NOT NULL,
  `verification_type` enum('edit_profile','password_change','sensitive_data') NOT NULL,
...
CREATE TABLE `leads` (
  ...
  `origem` varchar(100) DEFAULT NULL COMMENT 'Página de origem do lead',
  ...
  `crm_data_envio` datetime DEFAULT NULL,
  `observacoes` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Estrutura para tabela `leads_historico`
--
...
--
-- Estrutura para tabela `leads_webhook_log`
--
...
--
-- Índices de tabela `document_validations`
--
...
--
-- Índices de tabela `document_verifications`
--
...
--
-- Índices de tabela `facial_verifications`
--
...
ALTER TABLE `leads`
  ...
  ADD KEY `idx_empresa` (`id_empresa_master`),
  ADD KEY `idx_created` (`created_at`);

--
-- Índices de tabela `leads_historico`
--
...
--
-- Índices de tabela `leads_webhook_log`
--
ALTER TABLE `leads_webhook_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_lead_id` (`lead_id`),
...
--
-- AUTO_INCREMENT de tabela `document_validations`
--
ALTER TABLE `document_validations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `document_verifications`
--
ALTER TABLE `document_verifications`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `facial_verifications`
--
ALTER TABLE `facial_verifications`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `leads_historico`
--
ALTER TABLE `leads_historico`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `leads_webhook_log`
--
ALTER TABLE `leads_webhook_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Restrições para tabelas `document_validations`
--
ALTER TABLE `document_validations`
  ADD CONSTRAINT `fk_document_validations_cliente` FOREIGN KEY (`cliente_id`) REFERENCES `kyc_clientes` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `document_verifications`
--
ALTER TABLE `document_verifications`
  ADD CONSTRAINT `document_verifications_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `kyc_clientes` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `document_verifications_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;
...
--
-- Restrições para tabelas `facial_verifications`
--
ALTER TABLE `facial_verifications`
  ADD CONSTRAINT `facial_verifications_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `kyc_clientes` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `leads`
  ADD CONSTRAINT `leads_ibfk_1` FOREIGN KEY (`id_empresa_master`) REFERENCES `empresas` (`id`) ON DELETE SET NULL;

--
-- Restrições para tabelas `leads_historico`
--
ALTER TABLE `leads_historico`
  ADD CONSTRAINT `leads_historico_ibfk_1` FOREIGN KEY (`lead_id`) REFERENCES `leads` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `leads_historico_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL;

--
-- Restrições para tabelas `leads_webhook_log`
--
ALTER TABLE `leads_webhook_log`
  ADD CONSTRAINT `leads_webhook_log_ibfk_1` FOREIGN KEY (`lead_id`) REFERENCES `leads` (`id`) ON DELETE SET NULL;

--
-- Restrições para tabelas `login_attempts`
--
ALTER TABLE `login_attempts`
  ADD CONSTRAINT `login_attempts_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `kyc_clientes` (`id`) ON DELETE SET NULL;
