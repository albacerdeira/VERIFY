    ...
    <form action="kyc_submit.php" method="POST" enctype="multipart/form-data" id="kyc-form" novalidate>
        ...
        <div class="form-step" data-step="4">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control" id="doc_contrato_social" name="documentos[contrato_social]" required accept=".pdf,image/png,image/jpeg">
            </div>
            <div class="form-group">
                <label for="doc_ultima_alteracao">Última Alteração Societária (se houver)</label>
                <input type="file" class="form-control" id="doc_ultima_alteracao" name="documentos[ultima_alteracao]" accept=".pdf,image/png,image/jpeg">
            </div>
            <div class="form-group">
                <label for="doc_cartao_cnpj">Cartão do CNPJ *</label>
                <input type="file" class="form-control" id="doc_cartao_cnpj" name="documentos[cartao_cnpj]" required accept=".pdf,image/png,image/jpeg">
            </div>
            <div class="form-group">
                <label for="doc_balanco">Balanço do último ano *</label>
                <input type="file" class="form-control" id="doc_balanco" name="documentos[balanco_anual]" required accept=".pdf,image/png,image/jpeg">
            </div>
            <div class="form-group">
                <label for="doc_balancete">Balancete (últimos 3 meses) *</label>
                <input type="file" class="form-control" id="doc_balancete" name="documentos[balancete_trimestral]" required accept=".pdf,image/png,image/jpeg">
            </div>
            <div class="form-group">
                <label for="doc_dirpj">DIRPJ *</label>
                <input type="file" class="form-control" id="doc_dirpj" name="documentos[dirpj]" required accept=".pdf,image/png,image/jpeg">
            </div>
    ...
    function createUboCard(id, data = {}) {
        ...
        card.innerHTML = `
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6"><label for="socios_${id}_doc_identificacao">Doc. de Identificação (Frente e Verso) *</label><input type="file" class="form-control" id="socios_${id}_doc_identificacao" name="socios[${id}][doc_identificacao]" required accept=".pdf,image/png,image/jpeg"></div>
                    <div class="form-group col-md-6"><label for="socios_${id}_doc_endereco">Comprovante de Endereço *</label><input type="file" class="form-control" id="socios_${id}_doc_endereco" name="socios[${id}][doc_endereco]" required accept=".pdf,image/png,image/jpeg"></div>
                </div>
            </div>
